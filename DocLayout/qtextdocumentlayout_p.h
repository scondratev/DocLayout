...
{
    inline QTextDocumentLayoutPrivate* d_func() { return reinterpret_cast<QTextDocumentLayoutPrivate *>(p_ptr); }
    inline const QTextDocumentLayoutPrivate* d_func() const { return reinterpret_cast<const QTextDocumentLayoutPrivate *>(p_ptr); }
